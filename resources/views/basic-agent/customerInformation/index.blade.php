            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb pl-0">
                        <li class="breadcrumb-item"><a href="{{ route('basic-agent.dashboard') }}"><i class="material-icons"></i>Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('basic-agent.dashboard') }}">Dashboard</a></li>
     ...
     <script>
        $(document).ready(function() {
            $('#search-button').on('click', function() {
                ...
                var agent_id = {{ session('agent')->agent_id }};
                $.ajax({
                    url: '{{ route('basic-agent.customerinformation.search') }}',
                    type: 'GET',
                    data: { msisdn: msisdn ,
                        agent_id : agent_id
