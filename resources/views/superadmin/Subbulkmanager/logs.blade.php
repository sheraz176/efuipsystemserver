            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb pl-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Bulk IVR Subscription Subscription Api Logs</li>
                    </ol>
                </nav>
                ...
                <div class="ms-panel">
                    <div class="ms-panel-header ms-panel-custome align-items-center">
                        ...
                        <div class="col-md-4 mt-6" style="margin-left: -40%">
                            <a href="{{ route('superadmin.Subbuilkmanager.processSubfile') }}"> <button type="submit"
                                    class="btn btn-primary btn-sm">Bulk IVR Subscription Subscription</button>
                            </a>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('#myTables').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('superadmin.bulk.sub.api') }}",
                    data: function(d) {
