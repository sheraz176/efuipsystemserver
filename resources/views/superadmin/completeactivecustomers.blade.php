            ...
            <div class="col-md-12">
                ...
                <div class="ms-panel">
                    ...
                    <div class="ms-panel-header ms-panel-custome align-items-center">
                        ...
                        <div class="col-md-6">
                            <form method="POST" action="{{ route('superadmin.export-active-subription') }}">
                                @csrf
        ...
        $(function() {
            ...
            var table = $('#myTables').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'cps_transaction_id',
                        name: 'cps_transaction_id'
                    },
                    {
                        data: 'referenceId',
                        name: 'product_duration'
                    ...
                    {
                        data: 'recursive_charging_date',
                        name: 'recursive_charging_date'
                    },
                    {
