            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb pl-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Net Enrollments Report</li>
                    </ol>
                </nav>
                <div class="ms-panel">
                    ...
                    <div class="ms-panel-header ms-panel-custome align-items-center">
                        ...
                        <div class="col-md-6">
                            <form method="POST" action="{{ route('company-manager.export-complete.sale') }}">
                                @csrf
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('#myTables').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('companymanager.getData') }}",
                    data: function(d) {
