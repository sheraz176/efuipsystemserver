      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item">
              <a href="{{ route('super_agent_interested.dashboard') }}" class="menu-link">
        ...
        <div class="layout-page">
          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            ...
                            <small class="text-muted">Super Agent Interested</small>
                          </div>
                        </div>
                      </a>
                    </li>
              ...
              <form id="logout-form" action="{{ route('super_agent_interested.logout') }}" method="POST" style="display: none;">
                  @csrf
              </form>
                <!--/ User -->
              </ul>
