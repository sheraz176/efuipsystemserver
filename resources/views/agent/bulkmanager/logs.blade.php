            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb pl-0">
                        <li class="breadcrumb-item"><a href="{{ route('agent.dashboard') }}"><i class="material-icons"></i>Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('agent.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Bulk Refunds Manager Logs</li>
                    </ol>
                </nav>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('#myTables').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('agent.builkmanager.logsData') }}",
                    data: function(d) {
