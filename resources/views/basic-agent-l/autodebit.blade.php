            ...
            <div class="col-md-6">
                ...
                <form id="customerSearchForm" >
                    ...
                    <div class="form-group" style="padding-bottom: 10px;">
                        ...
                        <input type="text" class="form-control" value="{{ $existingRequest->msisdn ?? '' }}" id="customerMSISDN" name="customer_msisdn">
                    </div>
        ...
        <div class="row mt-3" id="customerDataSection" style="display: none;">
            <div class="col-md-12">
                ...
                <form id="customerDataForm">
                    ...
                    <button id="autoDebitButton" class="btn btn-primary" type="button" disabled>Proceed to Auto Debit</button>
