    ...
    <form class="modal-content">
      ...
      <div class="modal-body text-center">
        ...
        <p class="mt-3">Now, please inform the customer that they will need to press '1' to confirm the deduction when transferred to the IVR. After explaining this to the customer, go ahead and transfer the call to the IVR for digital consent.<br>
            ...
            پر منتقل کریں IVR پر منتقل کی جائے گی تو انہیں کٹوتی کی تصدیق کے لیے '1' دبانا ہوگا۔ یہ وضاحت کرنے کے بعد، کال کو ڈیجیٹل رضامندی کے لیے IVR.</p>
      </div>

      <div class="modal-footer text-center"> <!-- Centering the modal footer content -->
        <a href="{{ route('basic-agent-l.index') }}"><button type="button" class="btn btn-primary" >Proceed to Deduction</button></a>
      </div>
    </form>
  </div>
</div>
