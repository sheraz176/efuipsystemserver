...
class DiscountMonthlyRecusive extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'discount:monthly-recursive';
    ...
    ->get();
       ...
       $response = curl_exec($ch);
        ...
        Log::channel('discount_monthly_recusive')->info('Recusive Charging Api Monthly.',[
            'msisdn'=> $msisdn,
            'amount' => $amount,
            'url' => $url,
            'request-packet' => $body,
                        ...
                        $nextChargingDate = Carbon::parse($subscription->recursive_charging_date)->addDays($subscription->product_duration)->toDateString();
                         ...
                         ->update([
                           ...
                           $recusive_charging_data->save();
                                ...
                                Log::channel('discount_monthly_recusive')->info('Recusive Charging Discount Api Success.',[
