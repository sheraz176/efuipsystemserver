...
class DiscountTwoRec extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'discount:regular';
    ...
    ->whereIn('transaction_amount', [1]) // simplified
    ->get();
       ...
       $response = curl_exec($ch);
        ...
        Log::channel('discount_regular_recusive')->info('Recusive Charging Api Regular.',[
            'msisdn'=> $msisdn,
            'amount' => $amount,
            'url' => $url,
            'request-packet' => $body,
                        ...
                        $nextChargingDate = Carbon::parse($subscription->recursive_charging_date)->addDays($subscription->product_duration)->toDateString();
                         ...
                         ->update([
                           ...
                           $recusive_charging_data->save();
                                ...
                                Log::channel('discount_regular_recusive')->info('Recusive Charging Discount Api Success.',[
