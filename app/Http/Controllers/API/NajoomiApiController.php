...
class NajoomiApiController extends Controller
{
    ...
    public function najoomi_subscription(Request $request)
    {
              //dd($request->all());
                ...
                Log::channel('Najoomi_api')->info('Najoomi Subscription Api Request Parameters.',[
                ...
                $response = curl_exec($ch);
                  ...
                  // Logs
               Log::channel('Najoomi_api')->info('Najoomi Subscription Api.',[
                'subscriber_msisdn' => $request->input("subscriber_msisdn"),
                'url' => $url,
                'request-packet' => $body,
                ...
                if (isset($response['data'])) {
                    ...
                    $CustomerSubscriptionData = CustomerSubscription::create([
                        ...
                        'productId' =>$productId,
                        'policy_status' => 1,
                        'pulse' =>"najoomi_subscription",
                        'api_source' => "Najoomi Subscription",
                        'consent' => "DTMF-1",
