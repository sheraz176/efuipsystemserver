...
class AiBotsController extends Controller
{
    ...
    public function AI_bots_subscription(Request $request)
    {
              //dd($request->all());
                ...
                Log::channel('Aibots_api')->info('Aibots Subscription Api.',[
               ...
               Log::channel('Aibots_api')->info('Aibots Subscription Api.',[
                ...
                if (isset($response['data'])) {
                    ...
                    $CustomerSubscriptionData = CustomerSubscription::create([
                        ...
                        'productId' =>$productId,
                        'policy_status' => 1,
                        'pulse' =>"Aibots_subscription",
                        'api_source' => "Aibots Subscription",
                        'consent' => "DTMF-1",
