...
Route::get('/dailyCountThirdloop', [NetEntrollmentApiController::class, 'dailyCount3rdloop']);
    Route::get('/sehatplus-claims', [ClaimsController::class, 'showSehatPlus'])->name('sehatplus.claims');
        Route::get('/sehatplus-claims/data', [ClaimsController::class, 'getSehatPlusClaims'])->name('sehatplus.claims.data');

Route::post('/send-sms-sehat', [ClaimsController::class, 'sendSmsSehat'])->name('send.sms.sehat');
...
Route::prefix('super-agent-l')->group(function () {
 ...
 // Route group for super-agent-Interested dashboard requiring authentication
    Route::get('customer/claims/upload/index', [ClaimsController::class, 'customerclaimsuplaodindex'])->name('customer.claims.upload.index');
  Route::post('customer/claims/upload', [ClaimsController::class, 'customerclaimsuplaodstore'])->name('customer.claims.uplaod.store');
 Route::post('/msisdn/search-plans', [ClaimsController::class, 'searchPlans'])
    ->name('msisdn.search.plans');
...
Route::prefix('claims')->group(function () {
    ...
    Route::middleware(['super_agent_auth'])->group(function () {
        Route::get('/claim/dashboard', [SuperAgentDashboardControllerInterested::class, 'index'])->name('super_agent_interested.dashboard');
        ...
        Route::post('/claim/update-amount/pending', [ClaimsController::class, 'updatePendingcase'])->name('claim.update.amount.pending');
     ...
     Route::get('agent.claims', [ClaimsController::class, 'AgentshowClaimIndex'])->name('agent.new.claims');
        Route::get('agent-get-claims-data', [ClaimsController::class, 'AgentgetClaimsData'])->name('agent.get-claims-data');
        Route::post('agent-export-recusive-charging-data', [ClaimsController::class, 'Agentexport'])->name('agent.export-claim-data'); // make sure this exists
      Route::get('sendcustomersms.claims', [ClaimsController::class, 'sendcustomersms'])->name('customer.sendcustomersms');
      Route::post('/claims/message', [ClaimsController::class, 'message'])->name('claims.message');
        Route::get('customer.claims', [ClaimsController::class, 'CustomershowClaimIndex'])->name('customer.new.claims');
        Route::get('customer-get-claims-data', [ClaimsController::class, 'CustomergetClaimsData'])->name('customer.claims.get-claims-data');
