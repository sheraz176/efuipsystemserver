              ...
              <div class="row mb-5">
                ...
                <div class="card text-center">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">You have Provide Product Information to Customer All Benfits and Product Price.</p>
                      <a href="{{ route('basic-agent-l.transaction') }}" id="transactionpage" class="btn btn-lg btn-success">Start Subscription/Deduction</a>
