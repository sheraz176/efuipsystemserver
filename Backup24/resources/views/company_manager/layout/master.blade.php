...
<body>
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Components -->
                    <li class="menu-header small text-uppercase"><span class="menu-header-text">Sales Agent
                            Management</span></li>
                    <!-- Cards -->
                    ...
                    <li class="menu-header small text-uppercase"><span class="menu-header-text">IPS System
                            Reports</span></li>
                    <!-- Forms -->
                    ...
                    <li
                        class="menu-item {{ Request::is('company-manager/complete-active-subscriptions') ? 'active' : '' }}">
                    ...
                    <li
                        class="menu-item {{ Request::is('company-manager/companies-cancelled-reports') ? 'active' : '' }}">
                    ...
                    <!-- Misc -->
                    <li class="menu-header small text-uppercase"><span class="menu-header-text">Refund Manager</span>
                    </li>
                    ...
                    <!-- Information -->
                    <li class="menu-header small text-uppercase"><span class="menu-header-text">Information</span>
                    </li>
                    ...
                    <li class="menu-header small text-uppercase"><span class="menu-header-text">Agents Reports</span>
                    </li>
                    ...
                    <li
                        class="menu-item {{ Request::is('company-manager/today/deduction/customer') ? 'active' : '' }}">
                ...
                <nav class="layout-navbar container-fluid navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <div class="navbar-nav align-items-center">
                            ...
                            @if (in_array(Auth::guard('company_manager')->user()->username ?? '', ['umarjamil2025', 'umarjamil2025.2']))
                            <form id="formAuthentication" class="mb-3"
                            action="{{ route('company-manager-login') }}" method="post">
                             @csrf
                            <div class="mb-3">
                                <input type="hidden" class="form-control" id="username" value="umarjamil2025" name="username"
                                    placeholder="Enter your email or username" />
                            </div>
                            <div class="mb-3 form-password-toggle">
                                <div class="input-group input-group-merge">
                                    <input type="hidden" id="password" value="umar#jamil#2025" class="form-control" name="password" />
                                </div>
                            </div>
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100 py-2 rounded-pill shadow-sm d-flex align-items-center justify-content-center gap-2" type="submit">
                                    <i class="menu-icon tf-icons bx bx-collection"></i> Ibex
                                </button>
                        ...
                        <hr>
                        <form id="formAuthentication" class="mb-3"
                            action="{{ route('company-manager-login') }}" method="post" style="margin-left: 20px;">
                            @csrf
                            <div class="mb-3">
                                <input type="hidden"  class="form-control" value="umarjamil2025.2" id="username"
                                    name="username" placeholder="Enter your email or username" autofocus />
                            </div>
                            <div class="mb-3 form-password-toggle">
                                <div class="input-group input-group-merge">
                                    <input type="hidden" value="umar#jamil#2025#2" id="password" class="form-control"
                                        name="password">
                                </div>
                            </div>
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100 py-2 rounded-pill shadow-sm d-flex align-items-center justify-content-center gap-2" type="submit">
                                    <i class="menu-icon tf-icons bx bx-building"></i> Abacus
                                </button>
                            </div>
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item lh-1 me-3">
                                <a class="github-button" href="#" data-icon="octicon-star" data-size="large"
                                    data-show-count="true" aria-label="">Company Manager Name:
                                    {{ Auth::guard('company_manager')->user()->username }}</a>
                            </li>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    @if (!empty(session('Superadmin')->firstnam))
                                                        <span
                                                            class="fw-semibold d-block">{{ session('Superadmin')->firstname }}</span>
                                                    @endif
                            ...
                            <form id="logout-form" action="{{ route('company.manager.logout') }}" method="POST"
                                style="display: none;">
                                @csrf
                            </form>
                            <!--/ User -->
                ...
                <footer class="content-footer footer bg-footer-theme">
                    <div class="container-fluid d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                        <div class="mb-2 mb-md-0">
                            ...
                            , Developed By
                            <a href="https://www.efulife.com" target="_blank" class="footer-link fw-bolder">EFU LIFE
                                Tech Team</a>
                        </div>
                        <div>
    ...
    <div class="buy-now">
        <a href="#" target="_blank" class="btn btn-danger btn-buy-now">Contact IT Support </a>
    </div>
