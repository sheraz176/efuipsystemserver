...
<div class="container">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Tele Sales Agents/</span> Create New Agent</h4>
        @if ($errors->any())
        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('telesales-agents.store') }}">
                            @csrf
                            ...
                            <button type="submit" class="btn btn-primary">Create Telesales Agent</button>
                        </form>
                    </div>
                </div>
            </div>
